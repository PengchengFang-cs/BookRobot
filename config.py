...
# 与书本分割共用同一个7443 mTLS端点的书脊OCR任务合同。
BOOK_OCR_MODEL_VERSION = os.getenv(
    "BOOK_OCR_MODEL_VERSION", "ppocrv6-small-det-cls-rec-20260812"
)
BOOK_OCR_CONFIG_HASH = os.getenv(
    "BOOK_OCR_CONFIG_HASH",
    "9691f37cf4272dd499e1a252e9de653c58179eda2233c63ead7d03e5d15b80c1",
)
BOOK_OCR_VIEWPOINT_LAYOUT_HASH = os.getenv(
    "BOOK_OCR_VIEWPOINT_LAYOUT_HASH",
    "b237655180ee0ab87fa2fd4a6102482c1098c8922f7ed69f77207477ec6650a7",
)
BOOK_OCR_INVENTORY_CATALOG_HASH = os.getenv(
